...
\qquad
\subfloat[\centering Regressione parabolica sulla riga centrale una volta tolti i valori a 0]{{\includegraphics[width=4cm]{img/229-3.png} }}%
...
\qquad
\subfloat[\centering Regressione parabolica sulla riga centrale una volta tolti i valori a 0]{{\includegraphics[width=4cm]{img/458-3.png} }}%
...
\qquad
\subfloat[\centering Regressione parabolica sulla riga centrale una volta tolti i valori a 0]{{\includegraphics[width=4cm]{img/75-3.png} }}%
\caption{Immagine 75}
\end{figure}
...
\qquad
\subfloat[\centering Regressione parabolica sulla riga centrale una volta tolti i valori a 0]{{\includegraphics[width=4cm]{img/1345-3.png} }}%
